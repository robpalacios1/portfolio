        ...
        <div className="container">
            <h2 className="skills">Skills
                <CardDeck className="card__deck">
                    <Card className="card">
                        <Card.Img variant="top" src="https://1.bp.blogspot.com/-k6sMEsF31G8/Vss5FCL0_zI/AAAAAAAAACM/pWpHn_ZXMtw/s1600/HTML5-CSS3.png" className="img"/>
                        <Card.Body>
                            <Card.Title className="card__title">HTML & CSS</Card.Title>
                            <Card.Text>
                    ...
                    <Card>
                        <Card.Img variant="top" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Unofficial_JavaScript_logo_2.svg/1200px-Unofficial_JavaScript_logo_2.svg.png" className="img"/>
                        <Card.Body>
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            <Card.Title className="card__title">BOOTSTRAP</Card.Title>
                            <Card.Text>
                ...
                <CardDeck className="card__deck">
                    <Card className="card">
                        ...
                        <Card.Body>
                            <Card.Title className="card__title">GIT & GITHUB</Card.Title>
                            <Card.Text>
                    ...
                    <Card>
                        <Card.Img variant="top" src="https://www.pngitem.com/pimgs/m/664-6644509_icon-react-js-logo-hd-png-download.png" className="img"/>
                        <Card.Body>
                            <Card.Title className="card__title">REACT.JS</Card.Title>
                            <Card.Text>
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            <Card.Title className="card__title__nextjs">NEXT.JS</Card.Title>
                            <Card.Text>
                ...
                <CardDeck className="card__deck">
                    <Card className="card">
                        <Card.Img variant="top" src="https://www.cmswire.com/-/media/734f9fb4033b4f92b3d9babc0d72da41.ashx" className="img"/>
                        <Card.Body>
                            <Card.Title className="card__title__gatsby">GATSBY</Card.Title>
                            <Card.Text>
                    ...
                    <Card>
                        <Card.Img variant="top" src="https://www.pngitem.com/pimgs/m/31-312155_c-programming-language-logo-hd-png-download.png" className="img"/>
                        <Card.Body>
                            <Card.Title className="card__title">C LANGUAGE</Card.Title>
                            <Card.Text>
                ...
                <CardDeck className="card__deck">
                    <Card className="card">
                        ...
                        <Card.Body>
                            <Card.Title className="card__title__python">PYTHON</Card.Title>
                            <Card.Text>
                    ...
                    <Card>
                        <Card.Img variant="top" src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/35/Tux.svg/1200px-Tux.svg.png" className="img"/>
                        <Card.Body>
                            <Card.Title className="card__title">GNU/LINUX</Card.Title>
                            <Card.Text>
                    ...
                    <Card>
                        <Card.Img variant="top" src="https://yosoy.dev/wp-content/uploads/2013/02/jquery_logo.jpg" className="img"/>
                        <Card.Body>
                            <Card.Title className="card__title__jquery">JQUERY</Card.Title>
                            <Card.Text>
